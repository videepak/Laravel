...
<section class="textwithform">
	<div class="container">
			<div class="row">
				...
				@endif
				<div class="listText">
					<h2>Transforming the status quo of Valet Trash</h2>
					<ul>

					<li>Porter functions including service confirmations and violation capture</li>

					<li>Interactive dashboards available for status updates and service audit</li>

					<li>Property Manager tools available for daily service reports and violation documentation</li>
			...
			<div class="col-lg-4 col-md-6">
				<div class="sideForm">
				<h3>To watch our free demos, sign up now.</h3>
