...
<div class="right_col" role="main">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <div class="col-md-6">
                    <h2>Super Admin User</h2>
                </div>
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#add-superadmin">+ Super Admin User</a>
                    </li>
                </ul>
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" 
                  action="{{url('admin/add-super-admin')}}"
...
<script src="{{url('assets/trashscanjs/super.admin.list.js')}}"></script>
<script>
    $('.makeaction').click(
        function () {
            $('#preloader').show();
