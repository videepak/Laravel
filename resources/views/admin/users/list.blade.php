        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox"> 
                    <li>
                        <a class="btn btn-primary" href="{{url('admin/archive-user')}}">Archive</a>
                    </li>
                </ul> 
                    ...
                    <table id="subscriber" class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class="headings"> 
                                ...
                                <th class="column-title" width="1%">Action</th>
                            </tr>
                        </thead>
                    </table>
                </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal form-label-left" 
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" 
                           name="subscriber_id" id="user_id" required value=""
                           class="form-control" />
...
<script src="{{url('assets/trashscanjs/super.admin.user.list.js')}}"></script>
<script>
    $('.makeaction').click(
        function () {
            $('#preloader').show();
