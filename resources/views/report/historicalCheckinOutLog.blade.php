        ...
        <div class="x_panel">
          <div class="x_title">
              <h2 style="font-size: initial;">
                <i class="fa fa-bar-chart"></i> Historical Check In/Out Report
              </h2>
          ...
          <div class="x_content">
                <div class="table-responsive">
                    <table id="historicalTable" class="table table-striped jambo_table bulk_action">
                        <thead>
                            <tr class="headings"> 
                                ...
                                <th class="column-title">
                                  <select class="form-control input-sm filter"
                                    style="width: 72%;" id="property">
                                        <option value="">Property</option>
                                        @foreach($properties as $property)
                                        <option value="{{ $property->id }}">{{ ucwords($property->name) }}</option>
                                        @endforeach
                                        </option>
                                  </select>
                                </th>
                                ...
                                <th class="column-title">Service Duration</th>
                                <th class="column-title">Violations Logged</th>
...
<script src="{{url('assets/trashscanjs/historical.log.js')}}"></script>
