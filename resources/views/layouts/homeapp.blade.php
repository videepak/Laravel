...
<html lang="en">
    <head>
        ...
        <script src="{{url('assets/js/superfish.min.js')}}" type="text/javascript"></script>
        <script src="{{url('assets/js/jquery.flexslider-min.js')}}" type="text/javascript"></script>
        <script src="{{url('assets/js/animate.js')}}" type="text/javascript"></script>
        <script src="{{url('assets/js/myscript.js')}}" type="text/javascript"></script>
        <script src="{{url('assets/js/jquery.easing.js')}}" type="text/javascript"></script>	   
    </head>
    <body>
        <div id="page"> 
            <div class=""> 
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-12 text-right">
                                            ...
                                            <div class="pull-right developed-by"> Developed by &nbsp;
                                                <a href="https://www.galaxyweblinks.com/">
                                                    <img src="{{url('assets/images/galaxy-logo-1.png')}}" class="gwl-icon">
                                                </a> 
                                            </div>
                                        </div>
                                    </div>
