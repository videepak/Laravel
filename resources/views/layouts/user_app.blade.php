...
<html lang="en">
    <head>
        ...
        <link href="{{url('assets/build/css/trashscan.css')}}" rel="stylesheet">
        <link href="{{url('assets/vendors/bootstrap-daterangepicker/daterangepicker.css')}}" rel="stylesheet">    
        ...
        <link href="{{url('assets/trashscancss/trashscan.css')}}" rel="stylesheet">
                ...
                <footer>
                    <div class="text-center">
                        <a href="{{url('home')}}" target="_blank">
                            <img src="{{url('/assets/production/images')}}/Trash-Scan.png" 
...
$(document).ready(function() {
   ...
   <!--  <script src="{{url('assets/vendors/Flot/jquery.flot.js')}}"></script>
    ...
    <script src="{{url('assets/trashscanjs/trashscan.js')}}" type="text/javascript"></script>
