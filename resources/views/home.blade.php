...
@role('property_manager')
    @include('manager.managerdashboard')            
@else
...
<script>
$('#tags').autocomplete({
    serviceUrl: "{{url('/property-manager/search-unit')}}",
    onSelect: function (suggestion) {
        window.location.href = '{{url("/property-manager/unit-history")}}/' + suggestion.data;
    }
});
</script>
...
<script src="{{url('assets/trashscanjs/dashboard.js')}}"></script>

<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.13/js/bootstrap-multiselect.js"></script>  
<script language = "JavaScript">
var daliyReport = "{!! $user->daliy_status !!}";
