...
class UserController extends Controller
{
    ...
    public function index()
    {
        return response()->json(
            [
                ...
                'data' => [
                    'responseCode' => 201,
                    'responseMsg' => trans('app.session-expired'),
                ],
                'status' => 405,
            ],
            200
    ...
    public function login(Request $request)
    {
        ...
        $isSubscriber = 0;
        $check = \App\User::where('email', $request->email)->where('role_id', '!=', config('constants.propertyManager'))->exists();

        if ($check && $this->attemptLogin($request)) {
            ...
            return response()
                ->json(
                    [
                        'message' => trans('app.user-successfully-logged-in'),
                        'data'    => [
                            'user_id'      => $user->id,
                            'authToken'    => $api_token,
                            'userType'     => $userType,
                            ...
                            'responseCode' => 200,
                            'responseMsg'  => trans('app.login-successfully'),
                        ],
                        'status' => 200,
                    ]
                );
        //}
            ...
            return response()
                ->json(
                    [
                        'message' => trans('app.invalid-email-or-password'),
                        'data'    => [
                            'responseCode' => 201,
                            'responseMsg'  => trans('app.invalid-email-or-password'),
                        ],
                        'status' => 200,
                    ]
                );
        ...
        return $response == Password::RESET_LINK_SENT
                    ? response()->json(
                        [
                            ...
                            'data'    => [
                                'responseCode' => 200,
                                'responseMsg'  => trans('app.email-sent-successfully'),
                            ],
                                 'status' => 200,
                        ]
                    )
                    : response()->json(
                        [
                            'message' => trans('app.success'),
                             'data'   => [
                                'responseCode' => 201,
                                'responseMsg'  => trans('app.invalid-email'),
                             ],
                            'status' => 200,
                        ],
                        200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data'    => [
                            'responseCode' => 201,
                            'responseMsg'  => trans('app.user-detail-not-found'),
                        ],
                        'status' => 200,
                    ],
                    200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data'    => [
                            'responseCode' => 200,
                            'responseMsg'  => trans('app.profile-updated-successfully'),
                        ],
                        'status' => 200,
                    ],
                    200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data'    => [
                            'responseCode' => 201,
                            'responseMsg'  => trans('app.profile-not-updated-successfully'),
                        ],
                        'status' => 201,
                    ],
                    200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data'    => [
                            'responseCode' => 200,
                            'responseMsg'  => trans('app.password-updated-successfully'),
                        ],
                        'status' => 200,
                    ],
                    200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data'    => [
                            'responseCode' => 201,
                            'responseMsg'  => trans('app.old-password-does-not-match'),
                        ],
                        'status' => 200,
                    ],
                    200
        ...
        return response()
            ->json(
                [
                    ...
                    'data'    => [
                        'responseCode' => 200,
                        'responseMsg'  => trans('app.still-user-working'),
                    ],
                ],
                200
            );
    ...
    public function clockInClockOut(Request $request)
    {
        $validator = Validator::make(
            ...
            [
               'isClockIn.boolean'        => trans('app.clock-in-field-must-be-0-or-1'),
               'isManualCheckOut.boolean' => trans('app.manual-check-out-field-must-be-0-or-1'),
            ]
        );
                ...
                [
                    ...
                    'data' => [
                        ...
                        'responseMsg' => $request->isClockIn
                            ? trans('app.clocked-in-successfully')
                            : trans('app.clocked-out-successfully'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    public function clockInClockOutDetail(Request $request)
    {
        ...
        $clockDetail = \App\ClockInOut::query()
            ->select('clock_in as clock_in_utc', 'clock_out as clock_out_utc', \DB::raw("convert_tz(clock_in, 'UTC','" . $this->timezone . "') as clock_in"), \DB::raw("convert_tz(clock_out, 'UTC','" . $this->timezone . "') as clock_out"))
            ->where('user_id', $request->userId)
            ->whereBetween(
                \DB::raw("convert_tz(clock_in, 'UTC', '" . $this->timezone . "')"),
                [
                    $this->start,
                    $this->end
                ]
            ...
            ->json(
                [
                    ...
                    'data'    => [
                        ...
                        'responseCode'          => 200,
                        'responseMsg'           => trans('app.clocked-in-successfully'),
                    ],
                    'status' => 200,
                ],
                200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => 201,
                            'responseMsg' => trans('app.property-detail-not-found'),
                        ],
                        'status' => 200,
                    ],
                    200
    ...
    public function propertyCheckIn(Request $request)
    {
        ...
        if (!$this->checkLocationForWalkThrough($request->id, $request->lat, $request->long)) {
            $data = [
                ...
                'responseMsg' => trans('app.you-are-not-within-the-valid-radius'),
            ];
        ...
        $return = response()
            ->json(
                [
                    ...
                    'data' => [
                        'responseCode' => '200',
                        'responseMsg' => trans('app.checked-in-successfully'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    public function propertiesListV2()
    {
        ...
        $properties = \App\Property::orderBy('name')
            ->whereIn(
                'id',
                function ($query) {
        ...
        foreach ($properties as $property) {
            ...
            #1439: Task Management within Trash Scan : Start
            if ($checkPropertyIn->count() == 0) {
                $checkPropertyOut = $property->checkInProperty()
                    ->select('id', 'property_id', 'check_in_complete', 'created_at')
                    ->orderBy('id', 'desc')
                    ->where('user_id', $this->userId)
                    ->first();
            
                if (!is_null($checkPropertyOut) && $checkPropertyOut->check_in_complete)
                {
                    $isPreviewsDayCheckout  = true;
                } elseif (is_null($checkPropertyOut)) {
                    $isPreviewsDayCheckout  = true;
                } else {
                    $isPreviewsDayCheckout  = false;
                }
            } else {
                $isPreviewsDayCheckout  = true;
            }
            #1439: Task Management within Trash Scan : End
            ...
            $arr[] = [
                ...
                'isPreviewsDayCheckout' => $isPreviewsDayCheckout,
                'checkOutPendingDate' => isset($checkPropertyOut) ? $checkPropertyOut->created_at->timezone($this->timezone)->format('m-d-Y h:i A') : '',
                'routeCompleteFlag' => 0,
        ...
        if ($properties->isNotEmpty()) {
            ...
            $arrMain['responseMsg'] = trans('app.success');
            ...
            return response()->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 201,
                        'responseMsg' => trans('app.property-not-found'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    public function subProperties()
    {
        ...
        foreach ($properties as $property) {
            ...
            if (!empty($property->get_unit_count) && $property->check_in_property_count > 0 && $property->check_walk_through_count >= $property->get_building_count) {
                $property->allComplete = true;
            } elseif (!empty($property->get_unit_count) && $property->check_in_property_count > 0) {
                ...
                if (!empty($property->get_unit_count) && $property->get_unit_count == $proPickup->count()) {
                    $property->allComplete = true;
                }
            }
        }
            ...
            ->json(
                [
                    ...
                    'data' => [
                        ...
                        'responseCode' => 200,
                        'responseMsg' => trans('app.successfully'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    public function subProDetail(Request $request)
    {
        ...
        $notPickupList = Property::select('name', 'address', 'city', 'state', 'zip', 'id', 'type', 'state')
            ...
            ->with(
                [
                    ...
                    'task' => function ($query) {
                        $query->select('tasks.id', 'name', 'description', 'start_date', 'end_date', 'frequency', 'is_photo', 'barcode_id')
                            ->where('tasks.start_date', '<=', \Carbon\Carbon::now()->setTimezone($this->timezone))
                            ->where('tasks.end_date', '>=', \Carbon\Carbon::now()->setTimezone($this->timezone));
                    },
                    'routeCheckpoint',
                ]
            )
        ...
        if ($notPickupList->count() > 0) {
            foreach ($notPickupList as $key => $notPickupLists) {
                ...
                if (!empty($notPickupLists->get_unit_count) && ($notPickupLists->type == 2 || $notPickupLists->type == 3)) {
                    
                    //dd($notPickupLists->get_unit_count . '==' . $proPickup . '||' . $notPickupLists->check_walk_through_count . '==' . $notPickupLists->get_building_count);
                ...
                } else if (!empty($notPickupLists->get_unit_count)) {
                ...
                $taskDetail = $notPickupLists->task;
        
                if ($taskDetail->isNotEmpty()) {
                    foreach ($taskDetail as $taskDetails) {
                        $currDate = \Carbon\Carbon::now()->timezone($this->timezone);
                
                        if ($taskDetail[0]->frequency == 1) {
                            $start = $this->start;
                            $end = $this->end;
                        }
                    
                        if ($taskDetail[0]->frequency == 2) {
                            $start = \Carbon\Carbon::parse('last monday', $this->timezone)->addHours(6);

                            if ($currDate->dayOfWeek == \Carbon\Carbon::MONDAY) {
                                $end = \Carbon\Carbon::parse($currDate->format('Y-m-d') . ' 05:59:59', $this->timezone);
                            } else {
                                $end = \Carbon\Carbon::parse('next monday', $this->timezone)->addHours(5)->addMinutes(59)->addSeconds(59);
                            }
                        }
                
                        if ($taskDetail[0]->frequency == 3) {
                            $start = $currDate->startOfMonth()->addHours(6);
                            $end = new \Carbon\Carbon('first day of next month');
                            $end->startOfMonth()->addHours(5)->addMinutes(59)->addSeconds(59);
                        }
                        
                        $activity = \App\Activitylogs::where('barcode_id', $taskDetails->barcode_id)
                        ->whereBetween(
                            DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                            [
                                $start, $end
                        ...
                        $taskDetails->task_status = is_null($activity) ? 0 : 1;
                    }
                }

                $routeCheckpoint = $notPickupLists->routeCheckpoint;
        
                if ($routeCheckpoint->isNotEmpty()) {
                    foreach ($routeCheckpoint as $routeCheck) {
                        $activity = \App\Activitylogs::where('barcode_id', $routeCheck->barcode_id)
                            ->where('type', 11)
                            ->whereBetween(
                                DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                                [
                        ...
                        $routeCheck->routeCheckpoint_status = is_null($activity) ? 0 : 1;
                    }
                }
            
                //Task #1350:#1350: Enhance In-App Service Report : Start
                if ($request->status) {
                    $wal = [];
                    $totalPick = [];
                    ...
                    foreach ($walk as $walks) {
                        $wal[] = $walks->building_id;
                    }
                    ...
                    foreach ($totalPickup as $totalPickups) {
                        $totalPick[] = $totalPickups->building_id;
                    }

                    $mearge = collect($wal)->merge(collect($totalPick));
    ...
    public function routeCheck(Request $request)
    {
        $validator = Validator::make(
            ...
            [
                'barcode_id.exists' => trans('app.barcode-is-not-valid'),
            ]
        );
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => 201,
                            'responseMsg' => trans('app.redundant-route-successful'),
                        ],
                        'status' => 200,
                    ],
                    200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => (int) 201,
                            'responseMsg' => trans('app.route-checkpoint-already-completed'),
                        ],
                        'status' => 200,
                    ],
                    200
        ...
        return response()
            ->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 200,
                        'responseMsg' => trans('app.route-checked'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    **/
    ...
    protected function autoWalkthrough($property)
    {
        ...
        if ($checkPoint->count() == $activity->count()) {
            $activityId = \App\Activitylogs::create(
                [
                    'type' => 8,
    ...
    {
        $building = \App\Building::query()
            ->select('id', 'building_name', 'property_id', 'address')
            ->where(
                'property_id',
    ...
    public function scanQrcodeV2(Request $request)
    {
        $validator = Validator::make(
            ...
            [
                'barcode_id.exists' => trans('app.barcode-invalid'),
            ]
        );
        ...
        if (!is_null($routeCheck)) {
            return response()
                ...
                [
                    ...
                    'data' => [
                        'responseCode' => 201,
                        'responseMsg' => trans("app.route-checkpoint-thats-why-no-need-to-activation"),
                    ],
                    'status' => 200,
                ],
                200
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => 201,
                            'responseMsg' => trans('app.barcode-invalid'),
                        ],
                        'status' => 200,
                    ],
                    200
        ...
        if ($activeOrNot === 'Already Active.') {
            ...
            $data = [
                ...
                'responseCode' => 201,
                'responseMsg' => trans('app.already-active'),
            ];
            ...
            return response()->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 203,
                        'responseMsg' => trans('app.barcode-not-found'),
                    ],
                    'status' => 200,
                ],
                200
    ...
    public function reportViolation(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            [
                'barcode_id.exists' => trans('app.barcode-not-active'),
            ]
        );
        ...
        $data = [
            ...
            'responseCode' => 200,
            'responseMsg' => trans('app.violation-registered-successfully'),
        ];
    ...
    private function isPickupDay($barcode)
    {
        ...
        $propertyFrequency = \App\PropertyFrequencies::query()
            ->where(
                'property_id',
                function ($query) use ($barcode) {
                    $query->select('property_id')
    ...
    {
        $checkRoutePoint = \App\Units::select('id')
            ->where('barcode_id', $request->barcode_id)
            ->where('is_route', 1)
            ->first();
    ...
    private function scanPickup($request)
    {
                    ...
                    [
                        ...
                        'data' => $this->setData(
                            [
                                'responseCode' => 201,
                                'requestid' => $requestId,
                                'responseMsg' => trans('app.you-must-check-in-before-performing-this-activity-on-this-property'),
                            ]
                        ),
                        'status' => 200,
                    ],
                    ...
                    [
                        ...
                        'data' => $this->setData(
                            [
                                'responseCode' => 201,
                                'requestid' => $requestId,
                                'responseMsg' => trans('app.barcode-is-not-scheduled-for-today'),
                            ]
                        ),
                        'status' => 200,
                    ],
        ...
        if (!is_null($checkCount) && $checkCount->recycle) {
            return response()
                ->json(
                    [
                        'message' => trans('app.success'),
                        'data' => $this->setData(
                            [
                                'responseCode' => 200,
                                'requestid' => $requestId,
                                'responseMsg' => trans('app.recycle-already-done'),
                            ]
                        ),
                        'status' => 200,
                    ],
        ...
        if (!is_null($checkCount) && $pickupType->pickup_type != 3) {
            return response()->json(
                [
                    'message' => trans('app.success'),
                    'data' => $this->setData(
                        [
                            'responseCode' => 200,
                            'requestid' => $requestId,
                            'responseMsg' => trans('app.already-pickup'),
                        ]
                    ),
                    'status' => 200,
                ],
        ...
        if (is_null($checkCount)) {
            if ($pickupType->pickup_type == 1 || $pickupType->pickup_type == 3) {
                $this->sendnotification($barcode_id);
                $msg = 'Waste Collected';
                $wast = 1;
                $recycle = null;
            } elseif ($pickupType->pickup_type == 2) {
                $this->sendnotification($barcode_id);
                $msg = 'Recycle Done';
                $wast = null;
                $recycle = 1;
        ...
        } elseif (!is_null($checkCount) && $pickupType->pickup_type == 3) {
            $msg = 'Recycle Done';
            \App\Activitylogs::where('type', 2)
                ->where('barcode_id', $request->barcode_id)
                ->where('id', $checkCount->id)
                ->update(
                    [
                        'recycle' => 1,
                        'text' => $msg,
        ...
        // Auto walk through done : Start
        $units = \App\Units::select('property_id', 'building_id')
            ->where('property_id', $propertyDetail->property_id)
            ->where('building_id', $propertyDetail->building_id)
            ->where('is_route', 0)
            ->where('is_active', 1)
            ->get();
    ...
    private function scanPickupBackUp($request)
    {
        $validator = Validator::make(
            $request->all(),
            [
        ...
        if ($checkCount->isEmpty()) {
            ...
            if ($checkCount[0]->recycle != 1) {
                ...
                $msg = trans('app.recycle-already-done');
            }
        } else {
            $msg = trans('app.already-pickup');
        }
    ...
    public function manuallyPickup(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            [
                'unit_number.exists' => trans('app.invalid-unit-number'),
            ]
        );
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => '201',
                            'responseMsg' => trans('app.manual-pickup-option-is-disabled-by-the-admin'),
                        ],
                        'status' => 200,
                    ],
                    200
        ...
        if (!$this->checkLocation($barcode_id, $building, $lat, $long)) {
            $data = [
                'responseCode' => 201,
                'responseMsg' => trans('app.task-cannot-be-completed-at-your-current-location-user-must-be-within-valid-radius-of-property-address'),
            ];
    ...
    public function scanRevockBarcode(Request $request)
    {
        ...
        if ($barcode_id->isNotEmpty()) {
            ...
            if (isset($barcode_id[0]->type) && $barcode_id[0]->type == 1) {
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.barcode-deactivated')
                ];
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.pickup-rolled-back'),
                ];
                ...
                if ($checkStatus->isNotEmpty()) {
                    ...
                    $data = [
                        'responseCode' => 200,
                        'responseMsg' => trans('app.violation-rolled-back')
                    ];
                } else {
                    $delete = true;
                    $data = [
                        'responseCode' => 201,
                        'responseMsg' => trans('app.status-is-already-changed-by-admin'),
                    ];
                }
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.walk-through-rolled-back'),
                ];
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.check-in-rolled-back'),
                ];
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.check-out-rolled-back'),
                ];
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.route-checkpoint-check-rolled-back'),
                ];
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.redundant-route-service-rolled-back'),
                ];
            }
            ...
            if ($delete) {
                ...
                $data = [
                    'responseCode' => 200,
                    'responseMsg' => trans('app.activity-id-not-found.'),
                ];
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => 201,
                            'responseMsg' => trans('app.barcode-not-active'),
                        ],
                        'status' => 200,
                    ],
                    200
    ...
    public function createViolationV1(Request $request)
    {
        ...
        if (!is_null($check)) {
            $data = [
                ...
                'responseCode' => '206',
                'responseMsg' => trans('app.violation-has-been-created-already'),
        ...
        $activityId = Activitylogs::create(
            [
                //'text' => empty($unit->is_route) ? trans('app.violation-reported') : trans('app.route-checkpoint-violation-reported'),
                'type' => 3,
        ...
        if ($violation) {
            #1045: Property Manager Admin - Manage Residents : Start
            try {
                $resident = \App\Resident::where('unit_id', $property->id)->first();
            ...
            #1045: Property Manager Admin - Manage Residents : End
            ...
            try {
                ...
                $user = \App\Property::where('id', $property->property_id)
                    ...
                    ->get();
                //Send email notification to admins assigned to that property: Start
                if ($isNotify) {
                    \Notification::send(
                        $user[0]->getEmployee,
            ...
            //Send email notification to admins assigned to that property: End

            $data = [
                'responseCode' => '200',
                'responseMsg' => trans('app.violation-reported'),
                'requestid' => $requestId,
    ...
    public function uploadViolationImage(Request $request)
    {
        ...
        $requestId = !empty($request->requestid)
                ? $request->requestid : '';
        $msg = trans('app.violation-images-already-uploaded');
        ...
        foreach ($request->images as $file) {
            ...
            $filePath = 'uploads/violation/' . $name;
        ...
        if (!empty($data)) {
            ...
            $msg = trans('app.violation-image-uploaded-successfully');
        }
    ...
    public function walkThrough(Request $request)
    {
        ...
        if (!$this->checkRoutePoint($request->propertyId, $request->building_id)) {
            $data = [
                'responseCode' => (int) 201,
                'responseMsg' => trans('app.please-complete-all-mandatory-checkpoints-for-this-building'),
            ];
        ...
        if ($checkLocation) {
            ...
            if ($checkIfExists < 1) {
                ...
                $activityId = Activitylogs::create(
                    [
                        'text' => trans('app.walk-through-done'),
                        'user_id' => $this->userId,
                        'updated_by' => $this->userId,
            ...
            $data = [
                'responseCode' => '200',
                'responseMsg' => trans('app.walk-through-successfully-submitted'),
            ];
    ...
    public function reRoute(Request $request)
    {
        ...
        if ($request->reRoute) {
            ...
            $responseMessage = trans('app.redundant-route-service-started-successfully');
            $message = "Redundant Route Service Started Successfully";
        } else {
            ...
            $responseMessage = trans("app.redundant-route-service-stopped-successfully");
    ...
    public function activateCodeV2(Request $request)
    {
        ...
        if ($this->checkValidEmployee($request->barcode_id)) {
            ...
            if (isset($update) && !empty($update)) {
                $data = [
                    'responseCode' => '200',
                    'responseMsg' => trans('app.barcode-activated'),
                ];
    ...
    public function getActivityLog(Request $request)
    {
        ...
        $userActivityLogs = Activitylogs::query()
            ->select('id', 'user_id', 'text', 'barcode_id', 'wast', 'recycle', 'latitude', 'longitude', 'updated_by', 'property_id', 'building_id', 'type', 'task_frequency', 'created_at', 'updated_at', 'deleted_at', \DB::raw("(CASE WHEN (type = 5 or type = 2) THEN (CASE WHEN text = 'Pick up rollback.' THEN '1' WHEN text = 'Pickup Rolled-back' THEN 1 WHEN text = 'Violation Rolled Back' THEN '2' WHEN text = 'Redundant Route Service Complete.' THEN '3' WHEN text = 'Redundant Route Successful.' THEN '4' WHEN text = 'Redundant Route Service Rolled Back' THEN '5' WHEN text = 'Route checkpoint check rolled-back' THEN '6' WHEN text = 'Route Check Point' THEN '7' WHEN text = 'Check-in rolled-back' THEN '8' WHEN text = 'Check-out rolled-back' THEN '9' WHEN (text = 'Clock-Out Done.' or text = 'Clock-Out Done') THEN '10' WHEN text = 'Clock-In Done.' THEN '11' WHEN text = 'Walk Through Rolled-back' THEN '12' WHEN text = 'Recycle Done' THEN '13' WHEN text = 'Waste Collected' THEN '14' WHEN text = 'QR code deactivated.' THEN '15' WHEN text = 'QR code Deactivated' THEN '15' WHEN text = 'Barcode deactivated.' THEN '16' WHEN (text = 'Redundant route service started successfully.' or text = 'Redundant Route Service Started Successfully')THEN '17' END) END) as rollback_type"))
                ...
                ->json(
                    [
                        ...
                        'data' => $this->setData(
                            [
                                'responseCode' => 201,
                                'responseMsg' => trans('app.no-active-log-found'),
                            ]
                        ),
                        'status' => 200,
                    ],
        ...
        foreach ($userActivityLogs as $activity) {
            ...
            if (isset($activity->type) && $activity->type == 3) {
                $checkIsNewViolation = \App\Violation::query()
            ...
            $records[] = [
                ...
                'rollback_type' => $activity->rollback_type,
                'user_id' => $userId,
                'address1' => $address1,
                'address2' => $address2,
                'activity_id' => $activity->id,
    ...
    public function noteReason(Request $request)
    {
        ...
        $data = [
            'reason' => $reason,
            'responseCode' => 200,
            'responseMsg' => trans('app.note-reason-list'),
        ];
        $response = $this->setData($data);
     ...
     * Version v9: 1] #1439: Task Management within Trash Scan Comment #69, #86
     * 
     * @response {
     *   "message": "success",
     *   "data": {
    ...
    public function note(Request $request)
    {
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => '201',
                            'responseMsg' => trans('app.note-has-been-created-already'),
                        ],
                        'status' => 200,
                    ],
                    200
        ...
        #1439: Task Management within Trash Scan Comment #86 : Start
        if (!empty($request->is_checkout_note)) {
            $notesType = 3;
        } elseif (is_null($request->barcode_id)) {
            $notesType = 2;
        } else {
            $notesType = 1;
        }
        #1439: Task Management within Trash Scan Comment #86 : End
        ...
        #1439: Task Management within Trash Scan Comment #69 : Start
        if (isset($request->property_id) && $insert && !is_null($request->property_id)) {
            try {
                $propertyName = \App\Property::select('id', 'name')
                    ->where('id', $request->property_id)
                    ->first();

                $userDetail = \App\User::query()
                    ->select('id', 'email', 'firstname', 'lastname', 'role_id')
                    ->whereIn(
                        'id',
                        function ($query) use ($propertyName) {
                            $query->select('user_id')
                                ->from('user_properties')
                                ->where('property_id', $propertyName->id)
                                ->whereNull('deleted_at');
                        }
                    )
                    ->whereIn('role_id', [10, 1])
                ->get();
                
                foreach ($userDetail as $user) {
                    $content  = 'Dear ' . $user->firstname . ' ' . $user->lastname . ',<br/>';
                    $content .= 'Checkout note has created ' . 'for the ';
                    $content .= $propertyName->name;
                    $content .= '<br/><br/>Best regards,<br/><br/>';
                    $content .= 'Trash Scan Customer Support.<br/><br/>';

                    //1078: Unsubscribe from email notification: Start
                    $checkUser = \App\UserNotification::query()
                        ->where(
                            [
                                'type' => 10,
                                'user_id' => $user->id,
                    ...
                    if ($check) {
                        $user->notify(new EmailTemplate($content, 'Checkout note has created ' . $propertyName->name));
                    }
                }
            } catch (\Exception $e) {
            }
            #1439: Task Management within Trash Scan Comment #69 : End
        }
        ...
        return response()
            ->json(
                [
                    'message' => trans('app.success'),
                    'data' => [
                        'responseCode' => $insert ? 200 : 201,
                        'responseMsg' => $insert ? trans('app.notes-added-successfully')
                            : trans('app.notes-not-added'),
                        'requestid' => $requestId
                    ],
                    'status' => 200
                ],
        ...
        if ($update || $isUpload) {
            $data = [
                ...
                'responseMsg' => $request->isArchieve == 'true'
                    ? trans('app.archieve-note-successfully')
                    : trans('app.notes-updated-successfully'),
            ];
        } else {
            $data = [
                'responseCode' => 201,
                'responseMsg' => trans('app.notes-not-updated'),
            ];
        }
    ...
    public function getNoteByUnit(Request $request)
    {
        ...
        $data = [
            'notes' => $response,
            'responseCode' => 200,
            'responseMsg' => trans('app.note-list'),
        ];
...
//        });
    ...
    public function getReportIssueReason(Request $request)
    {
        ...
        if (isset($issueReason) && $issueReason->isNotEmpty()) {
            ...
            $data = [
                'responseCode' => 201,
                'responseMsg' => trans('app.reason-not-found'),
            ];
    ...
    public function reportIssue(Request $request)
    {
        ...
        if ($reportIssue) {
            $data = [
                'responseCode' => 200,
                'responseMsg' => trans('app.exception-generated-successfully-waiting-for-admin-review'),
            ];
            ...
            $data = [
                'responseCode' => 201,
                'responseMsg' => trans('app.report-issue-failed'),
            ];
    ...
    {
        $totalBarcodePerProperty = $totalBarcodeActivePerProperty = $pendingTask = 0;
        $buildingId = $propertyId = [];
        ...
        $notPickupList = \App\Property::select('id', 'name', 'address', 'city', 'state', 'zip', 'state', \DB::raw("2 as type"), 'type as proType')
            ...
            ->withCount(
                [
                    ...
                    'task' => function ($query) {
                        $query->where('tasks.start_date', '<=', \Carbon\Carbon::now()->setTimezone($this->timezone))
                            ->where('tasks.end_date', '>=', \Carbon\Carbon::now()->setTimezone($this->timezone));
                    }
                ]
            )
        ...
        if ($notPickupList->isNotEmpty()) {
            foreach ($notPickupList as $key => $notPickupLists) {
                ...
                #1439: Task Management within Trash Scan comment #37 : Start
                if ($notPickupLists->task->isNotEmpty()) {
                    $pendingTask = 0;
                    foreach ($notPickupLists->task as $taskDetail) {
                        $currDate = \Carbon\Carbon::now()->timezone($this->timezone);
                        ...
                        $activity = \App\Activitylogs::select('id')
                            ->where('barcode_id', $taskDetail->barcode_id)
                            ->whereBetween(
                                DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                                [
                                    $start, $end
                ...
                $notPickupLists['taskPending'] = $pendingTask;
                #1439: Task Management within Trash Scan comment #37 : End
                
                #1439: Task Management within Trash Scan : Start
                $checkPropertyOut = $notPickupLists->checkInProperty()
                    ->orderBy('id', 'desc')
                    ->whereBetween(
                        DB::raw("convert_tz(created_at,'UTC','" . $this->timezone . "')"),
                        [
                ...
                if (is_null($checkPropertyOut)) {
                    $checkOutPrevious = $notPickupLists->checkInProperty()
                    ->orderBy('id', 'desc')
                    ->where('user_id', $this->userId)
                    ->first();
                     
                    if (!is_null($checkOutPrevious) && !$checkOutPrevious->check_in_complete) {
                        $isCheckOutForDay = 3;
                    }
                    ...
                    if (is_null($checkOutPrevious)) {
                        $isCheckOutForDay = 2;
                    }
                }

                $notPickupLists['propertyCheckOut'] = $isCheckOutForDay;
                #1439: Task Management within Trash Scan : End
    ...
    private function getUserDetailByToken($authToken)
    {
        if (!empty($authToken)) {
            ...
            $userId = User::where('api_token', $authToken)->first();
            if (!is_null($userId)) {
                return $userId;
            }
        } else {
    ...
    private function base64ToImage($imageData, $id, $imageType, $type = '')
    {
        $time = time();
        ...
        // else {
        //     $imgPerfix = 'violation_';
        //     $folderName = 'violation/';
        //     $tablName = '\App\violation';
        // }

        $imgdata = base64_decode($imageData);
        $imageBase64 = base64_decode($imageData);
        $file = 'uploads/' . $folderName . $imgPerfix . $id . '.' . $imageType;
        ...
        Storage::disk('s3')->put($file, $imgdata);

        //file_put_contents($file, $imageBase64);
        
        $violation = $tableName::withTrashed()->find($id);
        $violation->image_name = $imgPerfix . $id . '.' . $imageType;
    ...
    {
        try {
            $date = \Carbon\Carbon::now()->timezone($this->timezone)->format('d-m-Y');
            ...
            if ($bar->isEmpty()) {
                ...
                foreach ($userDetail as $user) {
                    ...
                    if (is_null($checkUser) || (!is_null($checkUser) && !empty($checkUser->email))) {
                        $check = true;
                    } else {
                        $check = false;
                    }

                    if (is_null($checkUser) || (!is_null($checkUser) && !empty($checkUser->sms))) {
                        $smsCheck = true;
                    } else {
                        $smsCheck = false;
                    }
                    ...
                    if ($smsCheck) {
                        ...
                        $content .= 'Trash Scan Customer Support.';
                    ...
                    //1078: Unsubscribe from email notification: End
                        ...
                        if (is_null($checkUser) || (!is_null($checkUser) && $checkUser->email)) {
                            $mob = '+1' . \Auth::user()->mobile . '';
                            sms($mob, 'First pick up done for ' . $propertyName->name . ' ' . $date . '');
                        }
                    }
                }
            }
    ...
    private function notiicationForCheckin($propertyId)
    {
        try {
            ...
            //1078: Unsubscribe from email notification: Start
            $isNotify = $this->isNotification('email', 3);
            //1078: Unsubscribe from email notification: End

            $mail = \App\Property::query()
                ->select('id', 'name', 'address', 'city', 'state', 'zip', 'user_id', 'subscriber_id', 'created_at', 'updated_at', 'resident_alert')
                ->where('id', $propertyId)
                ->with(
                    [
                        'getEmployee' => function ($query) use ($isNotify) {
            ...
            if (isset($mail->address) && !empty($mail->address)) {
            ...
            #1085: Service Alerts to Residents: Start
            if (!is_null($mail) && !empty($mail->resident_alert) && !empty($this->subcriber->resident_alert)) {
                $residents = \App\ServiceAlertResidents::query()
                ...
                foreach ($residents as $resident) {
                    $data = [
                        'message' => 'Trash Scan App: Welcome! Reply YES to opt-in and receive future Valet Trash Service Alerts for your community ' . ucwords($mail->name) . '. Msg&data rates may apply.',
                        'logo' => getLogo()['logo'],
                        'companyName' => getLogo()['companyName'],
                    ];
            
                    Mail::to($resident)->send(new updateResidentSendEmail($data));

                    $mobile = '+1' . $resident->mobile . '';
                    $content = 'Trash Scan App: ';
                    $content .= 'Valet trash services has started at your community' . $mail->name . '.';
                    $content .= 'Please make sure your trash bin has been placed for collection according to the valet trash policy. Reply STOP to this message if you no longer wish to receive service alerts.';
    
                    sms($mobile, $content);
                }
            }
            #1085: Service Alerts to Residents: End

            if (!is_null($mail) && $mail->getEmployee->isNotEmpty()) {
                $data = [
                    'propertyName' => $mail->name,
                    'address' => $address,
                ...
                $notify = \Notification::send($mail->getEmployee, new \App\Notifications\PropertyCheckIn($data));
            }
        ...
        return response()
            ->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 200,
                        'responseMsg' => trans('app.user-current-time'),
    ...
    */
    ...
    public function issueReport(Request $request)
    {
        $validator = Validator::make(
            ...
            [
                'type.boolean' => trans('app.the-type-field-must-be-0-or-1')
            ]
        );
        ...
        return response()
            ->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 200,
                        'responseMsg' => trans('app.issue-reported-successfully'),
                    ],
                    'status' => 200,
                ]
            );
    ...
    * Task
    *
    * Version v9: #1439: Task Management within Trash Scan
    *
    * @response {
    *  "message": "success",
    *  "data": {
    *      taskId => 102,
	*	   tasktitle => "Lily",
    *      description => cover all check points,
    *      start date => 2019-05-03 12:37:43,
    *      end date => "11-09-2021 12:29 AM",
    *      frequency => 1/2/3,
 	*	   ediaType => 1/2/3,
	*	   mediaUrl => https//:,
	*	   isMendatory => true/ false,
    *   },
    *   "status": 200
    * }
    */
    ...
    public function task(Request $request)
    {
        ...
        $url = url('uploads/task');
        
        $task = \App\Property::select('id')
            ->where('id', $request->property_id)
            ->with(
                [
                    'task' => function ($query) use ($url) {
                        $query->select('tasks.id', 'name', 'description', 'frequency', 'is_photo', 'start_date', 'end_date', 'barcode_id')
                            ->where('tasks.start_date', '<=', \Carbon\Carbon::now()->setTimezone($this->timezone))
                            ->where('tasks.end_date', '>=', \Carbon\Carbon::now()->setTimezone($this->timezone))
                            //->where('barcode_id', 'A5NW3QKWKQ')
                            ->with(
                                [
                                    'taskImage' => function ($query) use ($url) {
                                        $query->select('id', \DB::raw("CONCAT('" . $url . "/', files_name) as files_name"), 'task_id', 'media_type')
                                        ->whereBetween(
                                            DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                                            [
                                                $this->start, $this->end
        ...
        if ($taskDetail->isNotEmpty()) {
            foreach ($taskDetail as $taskDetails) {
                ...
                $taskDetails->task_status = $pendingTask;
            }
        }
    ...
    *   "data": {
    *      "responseCode": 200,
    *      "responseMsg": "Task submitted successfully"
    *   },
    *   "status": 200
    * }
    */
    ...
    public function taskSubmit(Request $request)
    {
        $validator = Validator::make(
            ...
            [
                ...
                'mediaType' => 'required_with:mediaUrl',
                'property_id' => 'required|integer|exists:task_assigns,property_id,task_id,' . $request->taskId . ',deleted_at,NULL',
            ],
            [
                'property_id.exists' => trans("app.task-not-assigned-on-the-given-property-id")
            ]
        );
        ...
        $task = \App\Tasks::find($request->taskId);
        
        $activity = new \App\Activitylogs;
        $activity->user_id = $this->userId;
        $activity->text = "Task completed";
        $activity->latitude = $request->lat;
        $activity->longitude = $request->long;
        $activity->updated_by = $this->userId;
        $activity->barcode_id = $task->barcode_id;
        $activity->property_id = $request->property_id;
        $activity->ip_address = $request->ip();
        $activity->type = 13;
        $activity->task_frequency = $task->frequency;
        $activity->save();
        ...
        if (!empty($request->media)) {
            foreach ($request->media as $file) {
                ...
                $name = uniqid() . str_replace(' ', '', $originalName);
                $name = str_replace(' ', '', $name);
                $filePath = 'uploads/task/' . $name;

                Storage::disk('s3')->put($filePath, file_get_contents($file));
                
                //$file->move(public_path() . '/uploads/task/', $name);

                $image = new \App\TaskImage;
                $image->files_name = $name;
                $image->task_id = $request->taskId;
                $image->media_type = $request->mediaType;
        ...
        return response()
            ->json(
                [
                    ...
                    'data' => [
                        'responseCode' => 200,
                        "responseMsg" => trans("app.task-submitted-successfully")
                    ],
                    'status' => 200,
                ]
            );
    ...
    *   "data": {
    *      "responseCode": 200,
    *      "responseMsg": "Property CheckOut Successfully."
    *   },
    *   "status": 200
    * }
    */

    public function propertyCheckout(Request $request)
    {
        $validator = Validator::make(
            $request->all(),
            [
        ...
        $routecheckIds = $isTaskCompleted = [];
        
        $property = \App\Property::select('id')
            ->where('id', $request->property_id)
            ->with(
                [
                    'task' => function ($query) {
                        $query->select('tasks.id', 'user_id', 'name', 'description', 'barcode_id', 'start_date', 'end_date', \DB::raw("0 as task_status"), 'frequency', 'is_photo', 'tasks.created_at', 'tasks.updated_at')
                            ->where('tasks.start_date', '<=', \Carbon\Carbon::now()->setTimezone($this->timezone))
                            ->where('tasks.end_date', '>=', \Carbon\Carbon::now()->setTimezone($this->timezone));
                    },
                    'getUnit' => function ($query) {
                        $query->select('id', 'property_id', 'unit_number', 'building', 'barcode_id', 'is_route')
                            ->where('is_route', 1);
                    }
                ]
            )
        ...
        if ($taskDetail->isNotEmpty()) {
            ...
            foreach ($property->task as $task) {
                $activity = \App\Activitylogs::where('barcode_id', $task->barcode_id)
                ->whereBetween(
                    DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                    [
                        $start, $end
        ...
        if ($property->getUnit->isNotEmpty()) {
            foreach ($property->getUnit as $routeCheck) {
                $activity = \App\Activitylogs::where('barcode_id', $routeCheck->barcode_id)
                    ->where('type', 11)
                    ->whereBetween(
                        DB::raw("convert_tz(updated_at,'UTC','" . $this->timezone . "')"),
                ...
                if (is_null($activity)) {
                    $routecheckIds[] = $routeCheck->id;
                }
            }
        }

        if (empty($request->reason) && (count($isTaskCompleted) || count($routecheckIds))) {
            return response()
                ->json(
                    [
                        'message' => trans('app.success'),
                        'data' => [
                            'responseCode' => 201,
                            'task' => count($isTaskCompleted) ? \App\Tasks::whereIn('id', $isTaskCompleted)->get() : [],
                            'checkPoint' => count($routecheckIds) ? \App\Units::select('id', 'property_id', 'unit_number', 'building', 'barcode_id', 'is_route')->whereIn('id', $routecheckIds)->get() : [],
                        ],
                        'status' => 200,
                    ]
                );
        } else {
            \App\PropertiesCheckIn::query()
                ->where('user_id', $this->userId)
                ->where('property_id', $request->property_id)
                ->orderBy('id', 'desc')
                ->limit(1)
            ...
            //Task #1614:#1614: Property Checkout Notification : Start
            try {
                $date = \Carbon\Carbon::now()->timezone($this->timezone)->format('m-d-Y H:i:s');
    
                $propertyName = \App\Property::select('id', 'name', 'resident_alert')
                        ->where('id', $request->property_id)
                        ->first();
                // dd($request->reason, $propertyName, $propertyName->resident_alert, $this->subcriber->resident_alert);

                #1085: Service Alerts to Residents: Start
                if (!empty($request->reason) && !is_null($propertyName) && !empty($propertyName->resident_alert) && !empty($this->subcriber->resident_alert)) {
                    ...
                    foreach ($residents as $resident) {
                        ...
                        $content = 'Trash Scan App: Valet trash services has completed at your community ' . ucwords($propertyName->name) . '.';
                        
                        $content .= 'You may now retrieve your trash bin.';
                        $content .= ' Reply STOP to this message if you no longer wish to receive service alerts';
                ...
                if (!is_null($propertyName)) {
                    $userDetail = \App\User::select('id', 'firstname', 'lastname', 'mobile', 'email')
                        ->whereIn(
                            'id',
                            function ($query) use ($request) {
                                $query->select('user_id')
                    ...
                    foreach ($userDetail as $user) {
                        //#1614: Property Checkout Notification: Start
                        $checkUser = \App\UserNotification::where(
                            [
                                'type' => 11,
                                'user_id' => $user->id,
                        ...
                        //#1614: Property Checkout Notification: End

                        if ($check) {
                            $content = '<b>Trash Scan Notification</b><br/>';
                            $content .= 'Hello ' . $user->firstname . ' ' . $user->lastname . ',<br/>';
                            $content .= 'Check out has been completed on ' . $date;
                            $content .= ' by ' . $this->userDetail->firstname . ' ' . $this->userDetail->lastname;
                            $content .= ' for ' . $propertyName->name;
                            $content .= '. Please login to view details related to the completed services.';
                            $content .= '<br/>-Do not reply-<br/>';
                            $content .= '<br/><br/>Best regards,<br/><br/>';
                            $content .= 'Trash Scan Customer Support.<br/><br/>';

                            $user->notify(new EmailTemplate($content, 'Property checkout done for ' . $propertyName->name . ' ' . $date . ''));
                        }

                        if ($smsCheck) {
                            $mobile = '+1' . $user->mobile . '';

                            $content = 'Trash Scan Notification, ';
                            $content .= 'Hello ' . $user->firstname . ' ' . $user->lastname . ',';
                            $content .= 'Check out has been completed on ' . $date;
                            $content .= ' by ' . $this->userDetail->firstname . ' ' . $this->userDetail->lastname;
                            $content .= ' for ' . $propertyName->name;
                            $content .= '. Please login to view details related to the completed services.';
                            $content .= 'Do not reply- ';
                            $content .= 'Best regards, ';
                            $content .= 'Trash Scan Customer Support. ';
            ...
            //Task #1614:#1614: Property Checkout Notification : Stop
            ...
            return response()
                ->json(
                    [
                        ...
                        'data' => [
                            'responseCode' => 200,
                            "responseMsg" => trans('app.property-checkOut-successfully')
                        ],
                        'status' => 200,
                    ]
                );
    ...
    public function getPortersDetails(Request $request)
    {
        $employee = \App\User::query()
            ->select('id', 'title', 'firstname', 'lastname', 'mobile', 'email', 'subscriber_id', 'user_id')
            ->where('subscriber_id', $this->subscriberId)
            ->whereHas(
                'getActivities',
                function ($query) {
                    $query->whereIn('type', [3, 11, 2, 7, 1]);
                }
            )
            ->with(
                [
                    'getActivities' => function ($query) {
                        $query->select('id', 'user_id', 'text', 'barcode_id', 'latitude', 'longitude', 'property_id', 'building_id', \DB::raw("convert_tz(updated_at, 'UTC', '" . $this->timezone . "') as activity_time"), \DB::raw("(CASE WHEN type = 3 THEN '1' WHEN type = 11 THEN '2' WHEN type = 2 THEN '3' WHEN type = 1 THEN '4' WHEN type = 7 THEN (CASE WHEN text = 'Property Checked-in' THEN '5' WHEN text = 'Property Checked-out' THEN '6' END) END) as activity_performed"))
                            ->orderBy('id', 'DESC')
                            ->whereIn('type', [3, 11, 2, 7, 1])
                            ->with(
                                [
                                    ...
                                    'unit' => function ($query) {
                                        $query->select('id', 'address1', DB::raw('IFNULL(address2, "") as address2'), 'unit_number', 'property_id', 'building_id', 'barcode_id')
                                            ->withTrashed();
                                    },
                                    'getBuilding' => function ($query) {
                                        $query->select('id', 'building_name', 'unit_number', 'property_id', 'address')
                                            ->withTrashed();
                                    }
                                ]
                            );
        ...
        ->map(
            function ($user) {
                $user->setRelation('getActivities', $user->getActivities->take(1));
                return $user;
            }
        );
    ...
    public function getUnit(Request $request)
    {
        ...
        $building = \App\Units::query()
            ->select('id', 'unit_number', 'is_route', 'barcode_id')
            ->where('property_id', $request->propertyId)
            ->when(
                !empty($request->buildingId),
                function ($query) use ($request) {
    ...
    public function getViolation(Request $request)
    {
        ...
        $url = url('/uploads/violation');
        //$url = env('AWS_URL') . '/uploads/violation';
        //$url = Storage::disk('s3')->temporaryUrl('uploads/violation', now()->addMinutes(30));
        $limit = $request->record_per_page;
        $offset = $request->page ? $request->page : 1;

        $violation = \App\Violation::query()
            ->select('id', 'violation_reason', 'violation_reason', 'violation_action', 'special_note', 'user_id', 'barcode_id', 'property_id', 'building_id', 'activity_id', \DB::raw("DATE_FORMAT(CONVERT_TZ(created_at,'UTC','" . $this->timezone . "'),'%Y-%m-%d %H:%i:%s') as create_at"))
            ...
            ->whereIn(
                ...
                function ($query) {
                    $query->select('id')
                        ->from('users')
                        ->where('subscriber_id', $this->subcriber->id);
                }
            )
            ->offset(($offset - 1) * $limit)
            ->limit($limit)
            ->with(
                [
                    'getProperty' => function ($query) {
                        $query->select('id', 'name', 'address', 'city', 'state', 'zip')
                            ->with(
                                [
                    ...
                    'getBuilding' => function ($query) {
                        $query->select('id', 'building_name', 'property_id', 'address');
                    },
                    'getUnitNumber' => function ($query) {
                        $query->select('id', 'unit_number', 'barcode_id');
                    },
                    'getUser' => function ($query) {
                        $query->select('id', 'title', 'firstname', 'lastname', 'mobile', 'email');
                    },
                    ...
                    'images' => function ($query) use ($url) {
                        $query->select('id', DB::raw('CONCAT("' . $url . '", "/", filename) AS filename'), 'violation_id');
                    },
                ]
            )
            ->latest()
